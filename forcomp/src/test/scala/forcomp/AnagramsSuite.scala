...
class AnagramsSuite extends munit.FunSuite:
  ...
  test("sentenceOccurrences: edcb a (5pts)") {
    assertEquals(sentenceOccurrences(List("edcb", "a")), List(('a', 1), ('b', 1), ('c', 1), ('d', 1), ('e', 1)))
  }
  ...
  test("combinations: ab") {
    ...
    assertEquals(combinations(ab).toSet, abcomb.toSet)
  }
